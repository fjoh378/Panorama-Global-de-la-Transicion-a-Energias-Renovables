...
COL_FOSSIL_SHARE <- "Fossil fuels (% equivalent primary energy) (fossil-fuels-share-energy)"
COL_RENEW_SHARE  <- "Renewables (% equivalent primary energy) (renewable-share-energy)"
...
write_csv(df_all, "predicciones_world_fossil_renew_lstm_train_test.csv", na = "")
...
ggplot(df_plot_long,
  ...
  labs(
    ...
    subtitle = "Línea sólida: datos históricos · Línea segmentada: predicción LSTM\nÁrea sombreada: horizonte de pronóstico",
    x = "Año",
